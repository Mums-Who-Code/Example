...
namespace Example.Tests.Unit.Services.Foundations.Samples
{
    public partial class SampleServiceTests
    {
        ...
        public void ShouldThrowValidationExceptionOnModifyIfSampleIsNullAndLogIt()
        {
            ...
            var expectedSampleValidationException = new SampleValidationException(nullSampleException);
        ...
        [InlineData("")]
        [InlineData("  ")]
        public void ShouldThrowValidationExceptionOnModifyIfSampleIsInvalidAndLogIt(string invalidText)
        {
            // given
